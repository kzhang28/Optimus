...
export nodes=${nodes:-"net@10.28.1.1 net@10.28.1.2 net@10.28.1.3 net@10.28.1.4 net@10.28.1.6 net@10.28.1.7 net@10.28.1.8 net@10.28.1.14 net@10.28.1.15"}

# Define all your nodes role: a(master) or i(minion) or ai(both master and minion),
# Roles must be the same order with the nodes.
roles=${roles:-"ai i i i i i i i i"}
...
export SERVICE_CLUSTER_IP_RANGE=${SERVICE_CLUSTER_IP_RANGE:-192.168.192.0/24}  # formerly PORTAL_NET
...
DNS_SERVER_IP=${DNS_SERVER_IP:-"192.168.192.168"}
...
SSH_OPTS="-oPort=22 -oStrictHostKeyChecking=no -oUserKnownHostsFile=/dev/null -oLogLevel=INFO"
